...
Дашборд предоставляет четыре основные вкладки:
...
| MRR | ≥ 0.80 | - | - | 🔴 Высокий |
| Faithfulness | - | ≥ 4.0 | - | 🔴 Высокий |
| Answer Relevance | - | ≥ 4.0 | - | 🔴 Высокий |
| E2E Score | - | - | ≥ 3.5 | 🔴 Высокий |
| Semantic Similarity | - | - | ≥ 0.70 | 🟡 Средний |
